console.log("connected - nativelottie / take two");
...
document.addEventListener("DOMContentLoaded", (event) => {
    ...
    // Process Section Animation
        const rawLottie = document.querySelector(".progress-lottie");
        const lottieInstance = Webflow.require('lottie').getInstance(rawLottie);
           ...
           .from(tagSplit[2].lines, {
            ...
            const ProgressAnimation = gsap.timeline({
                scrollTrigger: {
                    ...
                    scrub: 0.5,
                    onUpdate: (self) => {
                        const frame = lottieInstance.totalFrames * self.progress;
